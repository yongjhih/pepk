 ...
 * <p><b>Note for users of {@code java_and_gwt_*} BUILD macros</b>: When a class contains
 * {@code @GwtIncompatible} elements, it should be annotated as {@code @GwtCompatible(emulated =
 * true)} to acknowledge that {@code java_and_gwt_*} will generate a supersource version of it (to
