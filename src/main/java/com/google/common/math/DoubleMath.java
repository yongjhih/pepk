...
public final class DoubleMath {
  ...
  @GwtIncompatible
  /* MOE:insert public */ static double mean(double... values) {
  ...
  // com.google.common.math.DoubleUtils
  @GwtIncompatible
  /* MOE:insert public */ static double mean(Iterable<? extends Number> values) {
  ...
  // com.google.common.math.DoubleUtils
  @GwtIncompatible
  /* MOE:insert public */ static double mean(Iterator<? extends Number> values) {
